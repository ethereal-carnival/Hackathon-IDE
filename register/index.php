    ...
    <body>
        ...
        <center>
            <section id="register_box">
                <form action="/assets/functions/register.php" method="post" onsubmit="return validate();">
                    ...
                    <article class="inp-group">
                        ...
                        <input class="inp-txt inp-reg" type="number" placeholder="SAP ID" name="sap" id="sap" />
                    </article>
                    <article class="inp-group">
                    ...
                    <article class="inp-group">
                        <input class="inp-txt inp-reg" type="text" placeholder="Email ID (.upes.ac.in)" name="email" id="email" />
                        <input class="inp-txt inp-reg" type="number" placeholder="Contact Number" name="number" id="cno" />
                    </article>
                    <article class="inp-group">
